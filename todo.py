'''
En resumen, este código implementa las funciones básicas de una lista de tareas utilizando Flask y una base de datos. 
Las funciones están decoradas con la función login_required para garantizar que el usuario esté autenticado antes de 
